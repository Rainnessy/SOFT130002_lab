...
function Task1(bef){
    ...
    let leftdis = -600 * index;
    let wrap = document.getElementsByClassName("wrap")[0];
    wrap.style.left = leftdis + "px";
}
...
$(function(){
    $("td").click(function(event){
        ...
        input
            .width(td.width())
            .height(td.height())
            .css({border:"0px",fontSize:"17px",font:"宋体",background:"lavender",fontWeight:"bold",color:"black"})
            .val(preText)
            .appendTo(td)
            .trigger("focus")
            .trigger("select");
